...
export default {
  page: {
    title: "Unidad",
    meta: [{ name: "Unidad", content: appConfig.description }],
  },
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <router-link v-if="permisos_agregar == 1" to="/new-unidad" class="button btn-dark btn-sm" style="float: left">Nueva Unidad</router-link>
              </div>
