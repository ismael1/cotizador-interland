...
export default {
  ...
  data() {
    return {
      ...
      description: "",
      naturaleza: "Producto Manufacturado",
      optNaturaleza:[
        { id: 1, value: "Producto Manufacturado" },
        { id: 2, value: "Materia Prima" },
      ],
      peso: 0,
      namePeso: "mg",
      optPeso: [
  ...
  methods: {
    ...
    getProducto(){
      ...
      const idP = this.$route.params.pkProducto;
      ...
      .then((response) => {
        ...
        // this.naturaleza = response.data.naturaleza
        // this.peso = response.data.peso
        // this.namePeso = response.data.pesoName
        // this.longitud = response.data.longitud
        // this.nameLongitud = response.data.longitudName
        // this.superficie = response.data.superficie
        // this.nameSuperficie = response.data.superficieName
        // this.volumen = response.data.volumen
        // this.nameVolumen = response.data.volumenName
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-body" style="padding: 10px">
            <h5 class="header-title">Información del Producto</h5>
                    ...
                    <form class="form-horizontal" role="form">
                      ...
                      <div class="form-row form-group">
                        <label
                          ...
                          <div class="col-md-6">
                            <b-form-select
                            v-model.trim="naturaleza"
                            >

                            <option
                            v-for="natura in optNaturaleza"
                            :key="natura.id"
                            v-bind:value="natura.value"
                            >
                              {{ natura.value }}
                            </option>
                        ...
                        <label
                          ...
                          <div class="col-md-6">
                            <div class="input-group">
                              ...
                              <b-form-select
                              v-model.trim="namePeso"
                              class="form-control col-md-6"
                              >
                              <option
                              v-for="pesso in optPeso"
                              :key="pesso.id"
                              v-bind:value="pesso.value"                              
                              >
                              {{ pesso.value }}
                              </option>                              
                              </b-form-select>
                      ...
                      <div class="form-row form-group">
                        <label
                          ...
                          <div class="col-md-6">
                            <div class="input-group">
                              <b-form-input
                              v-model.trim="longitud"
                              class="form-control col-md-6"
                              >
                              </b-form-input>

                              <b-form-select
                              v-model.trim="nameLongitud"
                              class="form-control col-md-6"
                              >
                              <option
                              v-for="long in optLongitud"
                              :key="long.id"
                              v-bind:value="long.value"                              
                              >
                              {{ long.value }}
                              </option>                              
                              </b-form-select>
                      ...
                      <div class="form-row form-group">
                        <label
                          ...
                          <div class="col-md-6">
                            <div class="input-group">
                              <b-form-input
                              v-model.trim="superficie"
                              class="form-control col-md-6"
                              >
                              </b-form-input>

                              <b-form-select
                              v-model.trim="nameSuperficie"
                              class="form-control col-md-6"
                              >
                              <option
                              v-for="superf in optSuperficie"
                              :key="superf.id"
                              v-bind:value="superf.value"                              
                              >
                              {{ superf.value }}
                              </option>                              
                              </b-form-select>
                      ...
                      <div class="form-row form-group">
                        <label
                          ...
                          <div class="col-md-6">
                            <div class="input-group">
                              <b-form-input
                              v-model.trim="volumen"
                              class="form-control col-md-6"
                              >
                              </b-form-input>

                              <b-form-select
                              v-model.trim="nameVolumen"
                              class="form-control col-md-6"
                              >
                              <option
                              v-for="volu in optVolumen"
                              :key="volu.id"
                              v-bind:value="volu.value"                              
                              >
                              {{ volu.value }}
                              </option>                              
                              </b-form-select>
