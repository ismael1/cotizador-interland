...
export default {
  ...
  methods: {
    ...
    get_customers(mypage) {
      ...
      axios
        .get('/api/v1/list-servicio-filtro/', {
          params: {
            page: mypage,
            size: this.size,
            palabra: caracter
   ...
   editServicio(item) {
     ...
     this.$router.push(`/edit-servicio/${item.id}/`);
   },
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">                
                <router-link v-if="permisos_agregar == 1" to="/new-servicio" class="button btn-dark btn-sm" style="float: left" >Nuevo Servicio</router-link>
              </div>
