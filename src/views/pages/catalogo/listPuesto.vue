...
export default {
  page: {
    title: "Servicios",
    meta: [{ name: "Servicios", content: appConfig.description }],
  },
  ...
  methods: {
   ...
   editPuesto(item) {
     ...
     this.$router.push(`/edit-puesto/${item.id}/`);
   },
      ...
      const swalWithBootstrapButtons = Swal.mixin({
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.isConfirmed) {
            ...
            swalWithBootstrapButtons.fire(
              'Eliminado',
              'Puesto/Función Eliminado Exitosamente',
              'success'
            )
          } else if (
            ...
            swalWithBootstrapButtons.fire(
              'Cancelado',
              'Eliminar Puesto/Función Cancelado',
              'error'
            )
          }
        })
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">                
                <router-link v-if="permisos_agregar == 1" to="/new-puesto" class="button btn-dark btn-sm" style="float: left">Nuevo Puesto</router-link>
              </div>
                ...
                <div class="table-responsive">
                  ...
                  <b-table v-if="permisos_lectura == 1" class="table table-sm mb-0" :items="all_data" :fields="fields" small bordered responsive="sm" :per-page="perPage" :current-page="currentPage" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :filter="filter" :filter-included-fields="filterOn" @filtered="onFiltered" :selectable="true">
                    <template #cell(actions)="row">
                      ...
                      ||
                      <i v-if="permisos_editar == 1" class="fas fa-edit" @click="editPuesto(row.item)"></i>
                      ||
