...
export default {
  page: {
    title: "Customers",
    meta: [{ name: "Customers", content: appConfig.description }],
  },
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <router-link v-if="permisos_agregar == 1" to="/new-customer" class="button btn-dark btn-sm" style="float: left">Nuevo Cliente</router-link>
              </div>
