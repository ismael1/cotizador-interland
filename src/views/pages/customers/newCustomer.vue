...
export default {
  page: {
    title: "new Customer",
    meta: [{ name: "newCustomer", content: appConfig.description }],
  },
  components: {
    Layout,
    PageHeader,
  ...
  data() {
    return {
      ...
      vcredit: 0,
      vaccept: 0,
      vpay: 1, //Muestra por Defecto Pago por Semana

      statusweek: "true", //Cambiar Estatus de Pago por Semana
  ...
  methods: {
        ...
        axios({
          ...
          .then((response) => {
            ...
            return false;
              ...
              axios
                .post("/api/v1/customer/addFiles/", formData,
                {
                  headers: {
    ...
    getEstado(event) {
      const pkPais = event.target.value;
    ...
    save1() {
      ...
      if (this.form.email) {
        if (idC == 0) {
          ...
          axios({
            method: "put",
            url: `customers/${this.form.idCustomer}/`,
            data: {
              email: this.form.email,
              lada: this.form.lada,
              phone: this.form.telefono,
        ...
        if (this.form.name) {
          ...
          axios({
            ...
            .then((response) => {
              ...
              this.form.taxid = response.data.textId;
    ...
    save5_update() {
      ...
      axios({
        method: "put",
        url: `contactos/${this.form.idContact}/`,
        data: {
    ...
    showFiles(idFile) {
      ...
      axios
        .post("/api/v1/customer/showpDF/", formData, {
    ...
    save6(valor) {
      ...
      if (update > 0) {
        ...
        axios({
          method: "put",
          url: `datacomplementary/${this.form.idComplementario}/`,
          data: {
    ...
    listRutas() {
      // const idC = this.$route.params.pkCustomer;
      const idC = this.form.idCustomer;
      if (idC > 0) {
        axios
          .get(`/api/v1/list-rutas/${idC}/`)
          .then((response) => {
                          ...
                          <form class="form-horizontal" role="form">
                            ...
                            <v-autocomplete 
                              ...
                              <div class="input-group" v-show="activoCP_2 == true">
                                <b-form-input class="col-md-3"  placeholder="" v-model.trim="cp" @input="form.cp = form.cp.toUpperCase()"></b-form-input>
                        ...
                        <div class="p-2">
                          <form class="form-horizontal" role="form">
                            ...
                            >
                              <b-form-checkbox
                                name="vaccept"
                                @change="Aceptar(vaccept)"
                                >Aceptar Terminos y Condiciones</b-form-checkbox
                              >
                            </b-form-group>
