...
export default {
  page: {
    title: "Usuarios",
    meta: [{ name: "Lista de Usuarios", content: appConfig.description }],
  },
      ...
      const swalWithBootstrapButtons = Swal.mixin({
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.isConfirmed) {
            ...
            swalWithBootstrapButtons.fire(
              'Eliminado',
              'Usuarios Eliminado Exitosamente',
              'success'
            )
          } else if (
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">                
                <router-link v-if="permisos_agregar == 1" to="/new-user" class="button btn-dark btn-sm" style="float: left">Nuevo Usuario</router-link>
              </div>
