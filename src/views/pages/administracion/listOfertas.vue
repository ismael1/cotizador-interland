...
export default {
  page: {
    title: "Ofertas",
    meta: [{ name: "Ofertas", content: appConfig.description }],
  },
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <router-link v-if="permisos_agregar == 1" to="/new-oferta" class="button btn-dark btn-sm" style="float: left">Nueva Oferta</router-link>
              </div>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  ...
                  <b-table v-if="permisos_lectura == 1" class="table table-sm mb-0" :items="all_data" :fields="fields" small bordered responsive="sm" :per-page="perPage" :current-page="currentPage" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :filter="filter" :filter-included-fields="filterOn" @filtered="onFiltered" :selectable="true">
                    ...
                    <template v-slot:cell(rutaImg)="rutaImg">
                      <a :href="rutaImg.item.rutaImg" target="_blank">{{ rutaImg.item.rutaImg }}</a>
                    </template>
                    <template v-slot:cell(nombreImg)="ruta">
                      <img :src="ruta.item.rutaImg" style="width: 80px;">
                    </template>
