...
export default {
  ...
  methods: {
    ...
    addMarker(location) {
      ...
      console.log(`Marcador en Latitud: ${lat}, Longitud: ${lng}`);
    ...
    async getCentroLatLng() {
      ...
      try {
        ...
        if (results.length > 0) {
          ...
          console.log(this.lat_centro)
          console.log(this.lng_centro)
        } else {
          this.latLng = null;
        }
      } catch (error) {
              ...
              <b-row>
                ...
                <b-col md="4">
                  <div style="text-align:center">
                    <b-button id="boton" style="background-color: #2aab5c;" class="lg" @click="Save"><i class="fe-map-pin"></i> Guardar Geocerca</b-button>
                  </div>
                </b-col>
                <b-col md="4">
