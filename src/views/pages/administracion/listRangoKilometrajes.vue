...
export default {
  ...
  methods: {
    ...
    get_rangos(mypage) {
      ...
      axios
        .get('/api/v1/list-rango-kilometraje/', {
          params: {
            page: mypage,
            size: this.size,
            palabra: caracter,
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <router-link v-if="permisos_agregar == 1" to="/administracion/new-rango" class="button btn-dark btn-sm" style="float: left">Nuevo Rango</router-link>
              </div>
