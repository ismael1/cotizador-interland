...
export default {
  page: {
    ...
    meta: [{ name: "newProvider", content: appConfig.description }],
  },
  components: {
    Layout,
    PageHeader,
  ...
  methods: {
      ...
      if (idC > 0) {
        ...
        axios({
          ...
          data: {
            ...
            estatus: "1",
            idProvider: this.form.idCustomer.toString(),
          },
          auth: {
            username: "admin",
            password: "123",
    ...
    editContacto(id) {
      if (id > 0) {
        ...
        axios
          .get(`/api/v1/provider-contac-details/${id}/`)
          .then((response) => {
            console.log(response);
            this.form.area = response.data.area;
            this.form.nombreContacto = response.data.name;
