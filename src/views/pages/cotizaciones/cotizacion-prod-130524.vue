...
export default {
    ...
    methods: {
        ...
        async generateCotizacionFTL(val){
            ...
            /*if(this.tipoEnvioDetalleSi){
                document.getElementById("9cheServiciosFTL").checked = true;
                idServicio = 9
                nombreServicio = "INGRESO ADUANAL"
            }else{
                document.getElementById("11cheServiciosFTL").checked = true;
                idServicio = 11
                nombreServicio = "ENTREGA"
            }

            data = {idServicio: idServicio, nombreServicio: nombreServicio}
            this.adicionalesFTL.push(data);

            document.getElementById("10cheServiciosFTL").checked = true;
            idServicio = 10
            nombreServicio = "RECOLECCION"
            data = {idServicio: idServicio, nombreServicio: nombreServicio}
            this.adicionalesFTL.push(data);*/
        ...
        filasCotizacionFTL(val){
            ...
            for (let un = 0; un < this.datosUnidaddesFtlOcupar.length; un++) {
                data = {key: this.datosUnidaddesFtlOcupar[un].code_name, label:this.datosUnidaddesFtlOcupar[un].name}
                this.fields_table.push(data)
            }
                        ...
                        <div  class="col-md-12">
                            <b-card class="rounded">
                                ...
                                <b-row>
                                    <b-col md="10">
                                        <br>
                                        <b-table hover :items="items_table" :fields="fields_table" select-mode="multi" responsive="sm" ref="selectableTable" selectable @row-selected="selecciona_registro_cotizacion" thead-class="bg-primary text-white">
                                            ...
                                            <b-col md="6">
                                                ...
                                                <div class="primer-input-style">
                                                    <div class="segundo-input-style" :style="'width: 100% !important; border-radius: 10px !important;'">
                                                        ...
                                                        <div class="segundo-input-input-style segundo-input-input-input-style">
                                                            <template>
                                                                <b-input class="segundo-input-istyle-input" v-model="contacName" @input="contacName = contacName.toUpperCase()" placeholder="ESPINOSA UGALDE PABLO"></b-input>
                                                            </template>
                                                        </div>
                                                    </div>
                                                </div>  
                                            ...
                                            <b-col md="6">
                                                ...
                                                <div class="primer-input-style">
                                                    <div class="segundo-input-style" :style="'width: 100% !important; border-radius: 10px !important;'">
                                                        ...
                                                        <div class="segundo-input-input-style segundo-input-input-input-style">
                                                            <template>
                                                                <b-textarea class="segundo-input-istyle-input" v-model="contacDescription" @input="contacDescription = contacDescription.toUpperCase()" placeholder="DESCRIPCION DEL PRODUCTO"></b-textarea>
                                                            </template>
                                                        </div>
                                                    </div>
                                                </div>
