...
export default {
  ...
  methods: {
    ...
    showinputtServicio(event) {
      ...
      }else if(opcionServicio == 2 || opcionServicio == 3){
        this.input_origen = ""
                ...
                <form>
                  ...
                  <div class="form-row">
                    ...
                    <b-form-group class="col-md-6" label="Proveedor" label-for="proveedor">
                      ...
                      <v-autocomplete 
                        :items="dates_search_proveedor" 
                        v-model="proveedor" 
                        :get-label="getLabel_proovedor" 
                        :component-item='template_proveedor' 
                        @update-items="updateItems_proveedor"
                  ...
                  <b-form-group v-show="activoOrigen == true">
                    ...
                    <label class="form-label" v-if="activaRuta == true">Direccion</label>
                    <label class="form-label" v-else>Origen</label>
      ...
      <form class="px-3" action="#">
        ...
        <div class="form-group">
            ...
            <select
                id="estadoOD"
                class="form-control"
                v-model.trim="estadoOD"
                ref="seleccionado_estado"
            >
                <option
                v-for="estate in estatesOD"
                :key="estate.id"
        ...
        <div class="form-group">
          ...
          <b-form-input
            type="text"
            v-model.trim="cityOD"
            @input="cityOD=cityOD.toUpperCase()"
          ></b-form-input>
        </div>

        <div class="form-group text-right">
          <b-button class="width-md ml-1" variant="secondary" @click="show=false"
            >Cerrar</b-button>
          <b-button class="width-md ml-1" variant="primary" @click="saveOrigenDestino"
            >Guardar</b-button>          
        </div>
      </form>
    </b-modal>
