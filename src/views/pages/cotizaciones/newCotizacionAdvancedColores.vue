    ...
    async buscaLatLngCordenadas(lat, lng, tipoDireccion){
      ...
      if(geoDetalles.data['geocerca']['estatus']){
        ...
        const punto = new google.maps.LatLng(
          lat, // Reemplaza con la latitud del punto
          lng // Reemplaza con la longitud del punto
        );
      ...
      <div class="col-lg-12">
        <div class="card" style="border: none; box-shadow: none">
          <div class="card-body" style="padding: 10px; background-color: #f5f6f8">
            ...
            <div id="mapaOrigen" style="height: 100%;"></div>
            <div id="mapaDestino" style="height: 100%;"></div>
              ...
              <div class="row _2ka8NZmhs89Mkk9ABZSXJM" id="formOperaciones">
                ...
                <b-modal id="valorDeclaradoMercancia" no-close-on-esc no-close-on-backdrop hide-footer centered hide-close>
                  ...
                  <div class="form-group text-center">
                    ...
                    <b-button class="width-md ml-1" style="background-color: #2aab5c" @click="addServicios(2, 'SEGURO')"><b><i class="fe-check"></i> Guardar</b></b-button>
                  </div>
                </b-modal>
                ...
                <b-modal id="inicio-unidades" no-close-on-esc no-close-on-backdrop hide-footer centered hide-close size="lg">
                  ...
                  <div class="form-group text-center">
                    ...
                    <b-row>
                      <b-col v-for="(unit, index) in units" md="4" >
                        <b-card @click="validaUnidades(unit.id, unit.name)" style="cursor:pointer;">
                          <!--img :src="unit.imagen" style="width:100%;"-->
