...
export default {
  page: {
    title: "Tarifario",
    meta: [{ name: "Tarifario", content: appConfig.description }],
  },
  ...
  methods: {
    ...
    get_customers(mypage) {
      ...
      axios.get('/api/v1/list-tarifario-filtro/', {
        params: {
          page: mypage,
          size: this.size,
          palabra: caracter,
    ...
    get_customers2(mypage) {
      ...
      axios.get('/api/v1/list-tarifarioActivo-filtro/', {
        params: {
          page: mypage,
          size: this.size2,
          palabra: caracter,
    ...
    get_customers3(mypage) {
      ...
      axios.get('/api/v1/list-tarifarioInactivo-filtro/', {
        params: {
          page: mypage,
          size: this.size3,
          palabra: caracter,
    ...
    editTarifa(item) {
      this.$router.push(`/edit-tarifa/${item.idTarifa}/`);
    },
    ...
    deleteTarifa(item) {
      ...
      swalWithBootstrapButtons.fire({
        ...
        text: "Estas Seguro de Eliminar esta Tarifa?",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          ...
          axios({
            method: "put",
            url: `api/v1/eliminar-tarifa/${item.idTarifa}/`,
            data: {
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                  <router-link v-if="permisos_agregar == 1" to="/new-tarifa" class="button btn-dark btn-sm" style="float: left">Nueva Tarifa</router-link>
                </div>
              </div>
                            ...
                            <div class="table-responsive">
                              ...
                              <b-table v-if="permisos_lectura == 1" class="table table-sm mb-0" :items="all_data" :fields="fields" small bordered
                                ...
                                <template #cell(estatus)="row">
                                  ...
                                  <i v-show="row.item.estatus == 1" title="Activo" v-b-tooltip.hover="{ variant: 'success' }" class="fas fa-check-circle" style="color: #1abc9c;"></i> <!--Aceptado-->

                                  <i v-show="row.item.estatus == 2" title="Inactivo" v-b-tooltip.hover="{ variant: 'danger' }" class="fas fa-window-close" style="color: #f1556c;" @click="showRejected(row.item)"></i>
                                ...
                                <template #cell(actions)="row">
                                  <i v-if="permisos_editar == 1" class="fas fa-edit" @click="editTarifa(row.item)"></i>||
                                  <i v-if="permisos_pdf == 1" class="fas fa-file-pdf" @click="generatePDF(row.item)"></i> ||
                                  <!--i class="fas fa-edit"></i-->
                                  <i v-if="permisos_eliminar == 1" class="fas fa-trash" @click="deleteTarifa(row.item)"></i>
                                </template>
                              </b-table>
                            ...
                            <div class="table-responsive">
                              ...
                              <b-table v-if="permisos_lectura == 1" class="table table-sm mb-0" :items="all_data3" :fields="fields3" small bordered
                                ...
                                <template #cell(estatus)="row">
                                  ...
                                  <i title="Esperando Información" v-b-tooltip.hover="{ variant: 'primary' }" class="fas fa-times-circle" style="color: #f1556c;"></i>
