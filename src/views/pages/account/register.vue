  ...
  methods: {
    ...
    async register() {
      try {
        // if(this.username){
        //   Swal.fire({
        //       title: "Error Usuario: este valor puede contener únicamente letras, números y los caracteres @/./+/-/_",
        //       text: '',
        //       icon: 'warning',
        ...
        // let respuest=await auth_js.register(this.username, this.email, this.password);
        let respuest = auth_js.register(this.username, this.email, this.password);
        // let respuest = auth_js.prueba();
