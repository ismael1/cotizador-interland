...
export default {
  ...
  methods: {
    ...
    asignaValores(){
      //{"valnomCli":"Daniel Romero","valEmailLab":"danielrg841@gmail.com","valNomEmp":"Interland Prueba","valRFCCli":"ROGD960522MI5","valSitioWeb":"google.com","valCidOrig":"MEXICO, 02300, CIUDAD DE MEXICO","valCidDest":"MEXICO, 91709, VERACRUZ, VERACRUZ, VERACRUZ","valTipoMerc":"8 Pallets, Estibable, 320 KG por unidad","valTipoUnid":"Camioneta de 3.5","valDetalles":"Mercancia sumamente peligrosa"}
      this.datos =  JSON.parse(this.datos);

      let valida_nombres = this.datos.valnomCli;

      
      if(valida_nombres.split(' ').length - 1 > 0){

        valida_nombres = valida_nombres.split(' ');
        // Asignar cada elemento del array a una variable
        this.nombre = valida_nombres[0] || "";
        this.apellidos = valida_nombres[1] || "";
      }else{
        this.nombre = this.datos.valnomCli;
        this.apellidos = "";
      }
      this.email = this.datos.valEmailLab;
      this.nombre_empresa = this.datos.valNomEmp;
      this.rfc = this.datos.valRFCCli;

      this.idChatB = this.datos.valIdChat;
      console.log(this.idChatB);
  ...
  <Auth>
    ...
    <form action="#" @submit.prevent="tryToLogIn">
      ...
      <div class="form-group mb-0 text-center">
        <button class="btn btn-block" type="submit" value="Login" style="background-color: #056736; color: #ffffff;">Ingresar <i class="ri-login-box-line"></i></button>
      </div>
      <br>
      <div class="form-group mb-0 text-center">
        <p class="text-muted">
    ...
    <b-modal ref="my-modal" size="xl" hide-footer no-close-on-esc no-close-on-backdrop hide-header-close  title="Para poder generar una cotización, completa la siguiente información:">
      <div class="">
        <div class="card-body">
