...
export default {
  page: {
    ...
    meta: [{ name: "editRuta", content: appConfig.description }],
  },
  components: {
    Layout,
    PageHeader,
  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          text: "Lista Ajustes de Rutas",
          href: "/ajustesrutas/",
        },
        {
          text: "Editar Ajuste de Rutas",
          href: "/editRuta",
          active: true,
        },
      ],
  ...
  methods: {
    ...
    getAjustesRutas(){
      ...
      .then((response) => {
        ...
        this.tipCarga = response.data.tipoMercancia
        this.unidad = response.data.tipoUnidad
        this.envia = response.data.tipoEnvio
        this.priceKilometros = response.data.precioKilometros
        this.divisa = response.data.divisa
        this.selectTipoUnidad()
