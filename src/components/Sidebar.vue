...
<template>
    <!-- ========== Left Sidebar Start ========== -->
    <!-- ========== Left Sidebar Start ========== -->
    <div class="left-side-menu" style="display: none;" v-if="username == 'Invitado'">
        <!-- LOGO -->

        <div class="logo-box">
            <router-link to="/" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img src="@/assets/images/logointerland.png" alt height="18" />
                    <!-- <span class="logo-lg-text-light">Minton</span> -->
                </span>
                <span class="logo-lg">
                    <img src="@/assets/images/logointerland.png" alt height="45" />
    ...
    <!-- LOGO -->
    <div class="left-side-menu" v-else>
        <!-- LOGO -->
            ...
            <div class="user-box text-center">
                ...
                <div class="dropdown">
                    <a href="javascript: void(0);" class="text-reset dropdown-toggle h5 mt-2 mb-1 d-block"
                        data-toggle="dropdown">{{ nombreU }}</a>
                    ...
                    <template v-for="item in menuItems">
                        ...
                        <li v-if="!item.isTitle && !item.isLayout" :key="item.id">
                            <a v-if="hasItems(item)" href="javascript:void(0);"
                                @click="item.isMenuCollapsed = !item.isMenuCollapsed" :class="{
