...
<template>
  ...
  <div class="navbar-custom" style="left: 0px !important;" v-if="username == 'Invitado'">
        ...
        >
          <template slot="button-content" class="nav-link dropdown-toggle">
            <div class="nav-user mr-0">
              <img v-if="urlImg != null && urlImg != ''" :src="urlImg" alt="user-image" class="rounded-circle" />
              <img v-else src="@/assets/images/users/user.png" alt="user-image" class="rounded-circle" />
          ...
          <b-dropdown-item href="/miCuenta" v-if="username != 'Invitado'">
  ...
  <div class="navbar-custom" v-else>
    <div class="container-fluid">
      <ul class="list-unstyled topnav-menu float-right mb-0">
        <!-- <li class="d-none d-lg-block">
          <form class="app-search">
